...
public class MultipleChoiceForTests extends AbstractTrivia {
    ...
    /**
     * Constructs a new MultipleChoice trivia with the provided correct letter
     * value, array of answers, and question.
     * 
     * @param theCorrectLetter the correct letter (A-D) for this multiple choice
     *                         trivia
     ...
     * @throws NullPointerException     if theCorrectLetter, theAnswers, or
     *                                  theQuestion is null
     * @throws IllegalArgumentException if theCorrectLetter is not one character in
     *                                  length, if theCorrectLetter is not between A
     *                                  and D inclusive, the length of theAnswers is
     *                                  not equal to NUM_ANSWERS, if theQuestion is
     *                                  empty, or if any answers within theAnswers
     *                                  are empty
     */
    public MultipleChoiceForTests(final String theCorrectLetter, final String[] theAnswers, final String theQuestion) {
    ...
    @Override
    public Trivia copy() {
        return new MultipleChoiceForTests(getCorrectValue(), myAnswers, getQuestion());
    }
